...
def get_qdrant_files(collection_name: str, qdrant_store: QdrantStore, project_root: str) -> Set[str]:
            ...
            if hasattr(point, 'payload') and point.payload:
                ...
                if entity_type == 'file':
                    ...
                    if file_path:
                        ...
                        relative_path = normalize_path_to_relative(file_path, project_root)
...
def compare_file_sets(qdrant_files: Set[str], state_files: Set[str]) -> Dict[str, List[str]]:
...
def print_comparison_results(comparison: Dict[str, List[str]]):
